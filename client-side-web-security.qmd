...
We base our Theme: Master Client-Side Web Security on Planning a [Minimum Viable Nothing (MVN)](https://github.com/vanHeemstraSystems/minimum-viable-nothing).

## 2. Find the **Opportunities**.

See [Learning Client-Side Web Security](https://vanheemstrasystems.github.io/learning-client-side-web-security/)
